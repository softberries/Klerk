...
import com.softberries.klerk.gui.editors.PurchaseDocumentsEditor;

public class OpenPurchasesCommand implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		System.out.println("open document");
		 ...
		 try {
			page.openEditor(input, PurchaseDocumentsEditor.ID);
